<template>
  <div class="title-bar">
    <div class="title-drag-area">
      ...
      <div class="menu-bar">
        <div class="menu-item" @click="showMenu('文件', $event)">文件</div>
        <div class="menu-item" @click="showMenu('编辑', $event)">编辑</div>
        <div class="menu-item" @click="showMenu('视图', $event)">视图</div>
      </div>
    </div>
    <div class="window-controls">
      <div class="control-button settings-btn" @click="$emit('open-settings')" title="设置" aria-label="打开设置">
      ...
      <div class="control-button theme-toggle" @click="toggleTheme" title="切换主题" aria-label="切换主题">
      ...
      <div class="control-button minimize" @click="minimize" aria-label="最小化窗口">
        <svg width="12" height="12" viewBox="0 0 12 12"><path d="M1 6h10" stroke="currentColor" stroke-width="1"/></svg>
      </div>
      <div class="control-button maximize" @click="maximize" :title="isMaximized ? '还原' : '最大化'" :aria-label="isMaximized ? '还原窗口' : '最大化窗口'">
      ...
      <div class="control-button close" @click="close" aria-label="关闭窗口">
