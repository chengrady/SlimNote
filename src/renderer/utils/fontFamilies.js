const BASE_FONT_FAMILIES = [
  ...
  { label: '等线', value: 'DengXian', isMonospace: false, sortLabel: 'DengXian' },
  ...
  { label: '楷体', value: 'KaiTi', isMonospace: false, sortLabel: 'KaiTi' },
  { label: 'Lucida Console', value: '"Lucida Console"', isMonospace: true },
  { label: 'Menlo', value: 'Menlo', isMonospace: true },
  { label: '微软雅黑', value: 'Microsoft YaHei', isMonospace: false, sortLabel: 'Microsoft YaHei' },
  { label: '微软雅黑 UI', value: '"Microsoft YaHei UI"', isMonospace: false, sortLabel: 'Microsoft YaHei UI' },
  { label: 'Monaco', value: 'Monaco', isMonospace: true },
  { label: 'Segoe UI', value: '"Segoe UI"', isMonospace: false },
  { label: '黑体', value: 'SimHei', isMonospace: false, sortLabel: 'SimHei' },
  { label: '宋体', value: 'SimSun', isMonospace: false, sortLabel: 'SimSun' },
...
export const FONT_FAMILIES = Object.freeze(
  [...BASE_FONT_FAMILIES].sort((left, right) => (left.sortLabel || left.label).localeCompare(right.sortLabel || right.label, 'en-US', { sensitivity: 'base' }))
)
