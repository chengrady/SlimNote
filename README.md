...
SlimNote 是一个面向日常文件工作的桌面编辑器，适合处理 Markdown 编写、JSON 整理、代码修改、笔记记录、SQL 格式化、日志查看和 AI 辅助编辑等场景。它把基于 Monaco 的代码编辑能力、基于 Milkdown 的 Markdown 工作流、AI 助手面板，以及常用辅助工具面板放进同一个专注的桌面窗口里。
